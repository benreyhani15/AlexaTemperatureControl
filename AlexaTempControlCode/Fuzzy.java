...
public class Fuzzy {
    ...
    public static void main(String[] args) {
        ...
        double testTemp = 0;
        while (testTemp <= 40) {
            applyDesiredHotRuleBase(testTemp, sb);
            testTemp+=0.25;
        }
        sb.append('\n');
        sb.append('\n');
        ...
        testTemp = 0;
        while (testTemp <= 40) {
            applyDesiredWarmRuleBase(testTemp, sb);
            testTemp+=0.25;
        }
        ...
        testTemp = 0;
        while (testTemp <= 40) {
            applyDesiredComfyRuleBase(testTemp, sb);
            testTemp+=0.25;
        }
        ...
        testTemp = 0;
        while (testTemp <= 40) {
            applyDesiredCoolRuleBase(testTemp, sb);
            testTemp+=0.25;
        }
        ...
        testTemp = 0;
        while (testTemp <= 40) {
            applyDesiredColdRuleBase(testTemp, sb);
            testTemp+=0.25;
        }
        
        try {
            PrintWriter pw = new PrintWriter(new File("fuzzyData.csv"));
    ...
    private static void applyDesiredColdRuleBase(double temp, StringBuilder sb) {
	...
	double heatControl = defuzzify(heatTimeInference, TIME_SAMPLING_INTERVAL);
	double fanControl = defuzzify(fanTimeInference, TIME_SAMPLING_INTERVAL);
        
    sb.append(temp);
    sb.append(',');
    sb.append(heatControl);
    sb.append(',');
    sb.append(fanControl);
    sb.append('\n');


    System.out.println("Desired Cold... Heat-Time: " + heatControl + ", For test temp: " + temp);
    System.out.println("Desired Cold... Fan-Time: " + fanControl + ", For test temp: " + temp);
	System.out.println("");
    }

    
    private static void applyDesiredCoolRuleBase(double temp, StringBuilder sb) {
        double ruleOneWeight = MF_COLD[tempToArrayIndex(temp)];
        double [] ruleOneFanInference = new double [TOTAL_FAN_DATA_POINTS];
        ...
        System.out.println("Desired Cool... Heat-Time: " + heatControl + ", For test temp: " + temp);
        System.out.println("Desired Cool... Fan-Time: " + fanControl + ", For test temp: " + temp);
        System.out.println("");
 }

    
    private static void applyDesiredComfyRuleBase(double temp, StringBuilder sb) {
        double ruleOneWeight = MF_COLD[tempToArrayIndex(temp)];
        double [] ruleOneFanInference = new double [TOTAL_FAN_DATA_POINTS];
        ...
        System.out.println("Desired Comfy... Heat-Time: " + heatControl + ", For test temp: " + temp);
        System.out.println("Desired Comfy... Fan-Time: " + fanControl + ", For test temp: " + temp);
        System.out.println("");
  }

    
    private static void applyDesiredWarmRuleBase(double temp, StringBuilder sb) {
        double ruleOneWeight = MF_COLD[tempToArrayIndex(temp)];
        double [] ruleOneFanInference = new double [TOTAL_FAN_DATA_POINTS];
        ...
        System.out.println("Desired Warm... Heat-Time: " + heatControl + ", For test temp: " + temp);
        System.out.println("Desired Warm... Fan-Time: " + fanControl + ", For test temp: " + temp);
        System.out.println("");
 }
    
    private static void applyDesiredHotRuleBase(double temp, StringBuilder sb) {
        double ruleOneWeight = MF_COLD[tempToArrayIndex(temp)];
        double [] ruleOneFanInference = new double [TOTAL_FAN_DATA_POINTS];
        ...
        System.out.println("Desired-Hot... Heat-Time: " + heatControl + ", For test temp: " + temp);
        System.out.println("Desired-Hot... Fan-Time: " + fanControl + ", For test temp: " + temp);
        System.out.println("");
  }
